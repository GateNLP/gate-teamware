    ...
    <div>
      <b-navbar type="light" variant="light">
        ...
        <b-navbar-nav>
          ...
          <b-nav-item target="_blank" href="https://gatenlp.github.io/gate-teamware/"> Documentation <b-icon-box-arrow-up-right style="position: relative; font-size: 0.8em; padding-bottom: 0.2em;"></b-icon-box-arrow-up-right></b-nav-item>
